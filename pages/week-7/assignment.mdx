...
Complete [Week 5 Assignment](/week-5/assignment) and [Week 6 Assignment](/week-6/assignment). If you did not complete the Week 5 and Week 6 assignments, you can use another student's [solution](/student-work/github-accounts) by copying the files from their GitHub repository into your own.
...
- Copy `item-list.js`, `item.js`, `items.json`, and `page.js` from /week-6 to /week-7.
- Copy `new-item.js` from /week-5 to /week-7.
...
https://cprg306-assignments-master.vercel.app/week-7
