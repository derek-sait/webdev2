...
https://cprg306-assignments-master.vercel.app/week-3

### Application Requirements

- Use appropriate semantic HTML elements, e.g. `li` for list items.
- Use Tailwind CSS for styling. You are free to use any Tailwind classes you want and you do not need to match the [Example Output](https://cprg306-assignments.vercel.app/week-3). However, your app should look good and be easy to use. Choose a colour scheme that is easy on the eyes. I recommend choosing two colours and using shades of those colours for your app.
